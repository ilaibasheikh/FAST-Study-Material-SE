...
public class ScientificCalc extends JFrame{
    ...
    private JButton ʸButton;
    private JButton button16;
    private JPanel panel2;

    public  ScientificCalc(Calculator cal){
    ...
    setContentPane(ScientificCalc);
    a0TextField.setText("0");
    pack();
setVisible(true);

        ButtonGroup angleGroup = new ButtonGroup();
        angleGroup.add(degreesRadioButton);
        angleGroup.add(radiansRadioButton);
        angleGroup.add(gradsRadioButton);
degreesRadioButton.setSelected(true);
}
